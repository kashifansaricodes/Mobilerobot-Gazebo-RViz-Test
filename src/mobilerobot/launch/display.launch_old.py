...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'mobilerobot.urdf'
    xacro_file = "mobilerobot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "mobilerobot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("mobilerobot"), "rviz", "display_default.rviz"]
    )
